...
case 30:return"T"
case 31:return"U"
default:return r>19?""+r%10:(r>8&&(r-=1),String.fromCharCode(65+r-1))}}function f(e){for(var r=0,n=0;n<e.length;n++){var o=j(e[n])
r+=n%2==1?0-o:o}return Math.abs(r%10)}function j(e){var r=e.charCodeAt(0)
return(42===r?4:r-65+(r>82?4:r>73?2:1))%10}function s(e,r){return e.toUpperCase().padEnd(r,"*").split("")}var d=function(e){this.generate=function(e,r,n,j,s,d){try{var c=[]
c=c.concat(o(n)),c=c.concat(t(e)),c=c.concat(a(r)),c=c.concat(l(d)),c.push(i(j)),c.push(u(s))
var m=c.join("")
return m.slice(0,9)+f(c)+m.slice(9)}catch(e){console.log(e)}return"Error Occured"}}
r.exports=d},{}],6:[function(e,r,n){!function(e){"use strict"
e(function(e,r,n){var o=String(e).toUpperCase().replace(/[^A-Z]/g,"").split(""),t={BFPV:1,CGJKQSXZ:2,DT:3,L:4,MN:5,R:6},a=Object.keys(t).reverse(),l=o.map(function(e,r,n){for(var o in a)if(-1!=a[o].indexOf(e))return t[a[o]]})
n&&(l=l.filter(function(e){return e}))
var i=l.splice(0,1)[0]
l=l.filter(function(e,r,n){return 0===r?e!==i:e!==n[r-1]})
var u=l.length,f=r&&(f=~~(n?u:2*u/3.5))>3?f:3
return o[0]+(l.join("")+new Array(f+1).join("0")).slice(0,f)})}(void 0!==n?function(e){r.exports=e}:function(e){this.Soundex=e})},{}]},{},[1])(1)})
